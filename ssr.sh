...
#   Author: EchoShoot <http://about.tisrop.com>                   #
...
echo "# Author: Teddysun & EchoShoot                              #"
...
pre_install(){
	...
	# Set shadowsocksR config stream ciphers & default is aes-256-cfb
	while true
	do
	...
	# Set shadowsocksR config protocol & default is auth_aes128_sha1
	while true
	do
	...
	# Set shadowsocksR config obfs & default is tls1.2_ticket_auth
	while true
	do
